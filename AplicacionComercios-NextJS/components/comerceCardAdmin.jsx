...
export default function ComerceCardAdmin() {
        ...
        <div>
            <div className="grid grid-cols-2 gap-3 ml-3 my-3">
                ...
                <div class="relative w-11/12 mt-3">
                    ...
                    <input type="text" placeholder="Buscar por nombre" value={searchActivity} onChange={(e) => setSearchActivity(e.target.value)} id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-1">
                {sortedComercios.filter((comercio) => 
                    ...
                    comercio.nombreComercio && comercio.nombreComercio.toLowerCase().includes(searchActivity.toLowerCase())
                ).map((comercio) => (
                    <div key={uuidv4()} className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row w-11/12 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 mx-3 my-3">
                        ...
                        <div className="flex flex-col justify-between p-4 leading-normal">
                            ...
                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{comercio.direccion}</p>
                        </div>
                    </div>
                ))}
            </div>
